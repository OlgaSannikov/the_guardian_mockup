...
class Header extends React.PureComponent{
    ...
    <div id="headerMiddleDiv">
        ...
        <p>Culture</p>
        <p>Lifestyle</p>
        <p>More <span><img src={require("./images/arrowdown2.png")} /></span></p>
    </div>
    <div id="headerBottomDiv">
        <p>US Elections 2020</p>
        <p>World</p>
        <p>Environment</p>
        <p>Soccer</p>
        <p>Us Politics</p>
