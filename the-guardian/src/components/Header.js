    ...
    render(){
        return (<div>
                ...
                <div id="leftTopDiv">
                    ...
                    <button type="button" >Contribute <svg width="30" height="30" viewBox="0 0 30 30" class="inline-arrow-right__svg inline-icon__svg">
            <path d="M22.8 14.6L15.2 7l-.7.7 5.5 6.6H6v1.5h14l-5.5 6.6.7.7 7.6-7.6v-.9"></path>
        </svg> </button>
                    <button type="button" >Subscribe <svg width="30" height="30" viewBox="0 0 30 30" class="inline-arrow-right__svg inline-icon__svg">
            <path d="M22.8 14.6L15.2 7l-.7.7 5.5 6.6H6v1.5h14l-5.5 6.6.7.7 7.6-7.6v-.9"></path>
        </svg> </button>
        </div>
             <div id="rightTopDiv">
        ...
        <p> Search v</p>
            ...
            <svg  class="inline-the-guardian-logo__svg inline-logo__svg">
